...
# EB: New Lorentz structure for massive fermions. They are based on whether the fermions have positive, P, or negative, M, 
#     spin direction or if the fermion is internal, F.

PPV1 = Lorentz(name = 'PPV1',
               spins = [ 2, 2, 3],
               structure = 'Gamma(3,2,-1)*ProjP(-1,1)' )

PMV1 = Lorentz(name = 'PMV1',
               spins = [ 2, 2, 3],
               structure = 'Gamma(3,2,-1)*ProjP(-1,1)' )

MPV1 = Lorentz(name = 'MPV1',
               spins = [ 2, 2, 3],
               structure = 'Gamma(3,2,-1)*ProjP(-1,1)' )

MMV1 = Lorentz(name = 'MMV1',
               spins = [ 2, 2, 3],
               structure = 'Gamma(3,2,-1)*ProjP(-1,1)' )

PFV1 = Lorentz(name = 'PFV1',
               spins = [ 2, 2, 3],
               structure = 'Gamma(3,2,-1)*ProjP(-1,1)' )

FPV1 = Lorentz(name = 'FPV1',
               spins = [ 2, 2, 3],
               structure = 'Gamma(3,2,-1)*ProjP(-1,1)' )

MFV1 = Lorentz(name = 'MFV1',
               spins = [ 2, 2, 3],
               structure = 'Gamma(3,2,-1)*ProjP(-1,1)' )

FMV1 = Lorentz(name = 'FMV1',
               spins = [ 2, 2, 3],
               structure = 'Gamma(3,2,-1)*ProjP(-1,1)' )
