...
def vec_vec(V1,V2):
    ...
    "two vector bosons V1 and V2 with missmatched flow in the HELAS Fortran convention"
...
def vec_p(V,p):
    ...
    "in the matrix representation. Returns a scalar ([V| p |V>)"
...
def vec_pvs(V1,V2):
    "ZW: vec_pv without pre-assigned coordinates"
    inprod = '({}(3)*(DBLE({}(1)) - DIMAG({}(1))) - {}(4)*{}(2) - {}(5)*CONJG({}(2)) + {}(6)*(DBLE({}(1)) + DIMAG({}(1))))' \
        .format(V1,V2,V2,V1,V2,V1,V2,V1,V2,V2)
    return inprod 
...
def bra_eme_pbar(F,V3,P):
    ...
    comp1 = '(({}(4)*{}(3) - {}(3)*{}(4))*({}(1) + CI*{}(2)) + ({}(3)*{}(6) - {}(4)*{}(5))*({}(0) + {}(3)))' \
...
def vertex_replacer(text, vertex):
    ...
    if (vertex == 'LRV1P0_3'):
        LRV1P0_3_replace = '      DENOM = 2*COUP/(P3(0)**2-P3(1)**2-P3(2)**2-P3(3)**2 - M3 * (M3 -CI * W3))\n' \
            + '      V3(3) = DENOM*F2(5)*F1(3)\n'\
            + '      V3(4) = DENOM*F2(5)*F1(4)\n'\
            + '      V3(5) = DENOM*F2(6)*F1(3)\n'\
            + '      V3(6) = DENOM*F2(6)*F1(4)\n'
        text_copy = text_copy[:linebreaks[-10]+1] + LRV1P0_3_replace + text_copy[linebreaks[-4]+1:]
    if (vertex == 'RLV1P0_3'):
        RLV1P0_3_replace = '      DENOM = 2*COUP/(P3(0)**2-P3(1)**2-P3(2)**2-P3(3)**2 - M3 * (M3 -CI * W3))\n' \
            + '      V3(3) = DENOM*F1(5)*F2(3)\n'\
            + '      V3(4) = DENOM*F1(5)*F2(4)\n'\
            + '      V3(5) = DENOM*F1(6)*F2(3)\n'\
            + '      V3(6) = DENOM*F1(6)*F2(4)\n'
        text_copy = text_copy[:linebreaks[-10]+1] + RLV1P0_3_replace + text_copy[linebreaks[-4]+1:]
    if vertex == 'FFV1_0':
    ...
    if vertex == 'FFV1_1':
        init_replace = '      COMPLEX*16 TEMP1,TEMP2,TEMP3,TEMP4\n'\
            + '      COMPLEX*16 P1_11, P1_22\n'

        FFV1_1_replace = '      P1_11 = (P1(0)+P1(3))\n'\
            + 'C      P1_12 = (P1(1)-CI*P1(2))\n'\
            + 'C      P1_21 = (P1(1)+CI*P1(2))\n'\
            + '      P1_22 = (P1(0)-P1(3))\n'\
            ...
            + '      F1(3) = DENOM*CI*(P1_11*TEMP1 - F1(2)*TEMP2 - M1*TEMP4)\n'\
            + '      F1(4) = DENOM*CI*(P1_22*TEMP2 - CONJG(F1(2))*TEMP1 + M1*TEMP3)\n'\
            + '      F1(5) = DENOM*CI*(P1_11*TEMP3 - CONJG(F1(2))*TEMP4 + M1*TEMP2)\n'\
            + '      F1(6) = DENOM*CI*(P1_22*TEMP4 - F1(2)*TEMP3 - M1*TEMP1)\n'
        ...
        red12_replace = '      SUBROUTINE FFV1Re12_1(F2, V3, COUP, M1, W1, F1)\n'\
            ...
            + text_copy[linebreaks[-23]-8:linebreaks[-12]+21] + '\n'\
            + '      DENOM = COUP/(P1(0)**2-P1(1)**2-P1(2)**2-P1(3)**2 - M1 * (M1 -CI * W1))\n'\
            + '      F1(3) = DENOM*CI*(P1_11*TEMP1 - F1(2)*TEMP2)\n'\
            + '      F1(4) = DENOM*CI*(P1_22*TEMP2 - CONJG(F1(2))*TEMP1)\n'\
        ...
        red34_replace = '\n      SUBROUTINE FFV1Re34_1(F2, V3, COUP, M1, W1, F1)\n'\
            ...
            + text_copy[linebreaks[-23]-8:linebreaks[-13]-42] + '\n'\
            + '      TEMP3 = (V3(4)*F2(6) - V3(6)*F2(5))\n'\
            + '      TEMP4 = (V3(5)*F2(5) - V3(3)*F2(6))\n'\
            + '      DENOM = COUP/(P1(0)**2-P1(1)**2-P1(2)**2-P1(3)**2 - M1 * (M1 -CI * W1))\n'\
            + '      F1(3) = DENOM*CI*(-M1*TEMP4)\n'\
            + '      F1(4) = DENOM*CI*M1*TEMP3\n'\
            + '      F1(5) = DENOM*CI*(P1_11*TEMP3 - CONJG(F1(2))*TEMP4)\n'\
            + '      F1(6) = DENOM*CI*(P1_22*TEMP4 - F1(2)*TEMP3)\n'\
            + '      END'
    ...
    if vertex == 'FFV1_2':
        init_replace = '      COMPLEX*16 TEMP1,TEMP2,TEMP3,TEMP4\n'\
            + '      COMPLEX*16 P2_11, P2_22\n'

        FFV1_2_replace = '      P2_11 = (P2(0)+P2(3))\n'\
            + 'C      P2_12 = (P2(1)-CI*P2(2))\n'\
            + 'C      P2_21 = (P2(1)+CI*P2(2))\n'\
            + '      P2_22 = (P2(0)-P2(3))\n'\
            ...
            + '      F2(3) = DENOM*CI*(-P2_11*TEMP1 + F2(2)*TEMP2 + M2*TEMP4)\n'\
            + '      F2(4) = DENOM*CI*(CONJG(F2(2))*TEMP1 - P2_22*TEMP2 - M2*TEMP3)\n'\
            + '      F2(5) = DENOM*CI*(-P2_11*TEMP3 + CONJG(F2(2))*TEMP4 - M2*TEMP2)\n'\
            + '      F2(6) = DENOM*CI*(F2(2)*TEMP3 - P2_22*TEMP4 + M2*TEMP1)\n'
        ...
        red12_replace = '      SUBROUTINE FFV1Re12_2(F1, V3, COUP, M2, W2, F2)\n'\
            + text_copy[linebreaks[-35]+1:linebreaks[-25]+1]\
            + '      COMPLEX*16 TEMP1,TEMP2\n'\
            + text_copy[linebreaks[-23]-12:linebreaks[-14]-22] + '\n'\
            + '      DENOM = COUP/(P2(0)**2-P2(1)**2-P2(2)**2-P2(3)**2 - M2 * (M2 -CI * W2))\n'\
            + '      F2(3) = DENOM*CI*(-P2_11*TEMP1 + F2(2)*TEMP2)\n'\
            + '      F2(4) = DENOM*CI*(CONJG(F2(2))*TEMP1 - P2_22*TEMP2)\n'\
        ...
        red34_replace = '\n      SUBROUTINE FFV1Re34_2(F1, V3, COUP, M2, W2, F2)\n'\
            + text_copy[linebreaks[-35]+1:linebreaks[-25]+1]\
            + '      COMPLEX*16 TEMP3,TEMP4\n'\
            + text_copy[linebreaks[-23]-12:linebreaks[-15]-34] + '\n'\
            + '      TEMP3 = (V3(4)*F1(6) - V3(6)*F1(5))\n'\
            + '      TEMP4 = (V3(5)*F1(5) - V3(3)*F1(6))\n'\
            + '      DENOM = COUP/(P2(0)**2-P2(1)**2-P2(2)**2-P2(3)**2 - M2 * (M2 -CI * W2))\n'\
            + '      F2(3) = DENOM*CI*(M2*TEMP4)\n'\
            + '      F2(4) = DENOM*CI*(-M2*TEMP3)\n'\
            + '      F2(5) = DENOM*CI*(-P2_11*TEMP3 + CONJG(F2(2))*TEMP4)\n'\
            + '      F2(6) = DENOM*CI*(F2(2)*TEMP3 - P2_22*TEMP4)\n'\
            + '      END'
    ...
    if vertex == 'FFV1P0_3':
        FFV1P0_3_replace = '      DENOM = 2*COUP/(P3(0)**2-P3(1)**2-P3(2)**2-P3(3)**2 - M3 * (M3 -CI * W3))\n' \
            + '      V3(3) = DENOM*(F1(5)*F2(3)+F2(5)*F1(3))\n'\
            + '      V3(4) = DENOM*(F1(5)*F2(4)+F2(5)*F1(4))\n'\
            + '      V3(5) = DENOM*(F1(6)*F2(3)+F2(6)*F1(3))\n'\
            + '      V3(6) = DENOM*(F1(6)*F2(4)+F2(6)*F1(4))\n'
        text_copy = text_copy[:linebreaks[-10]+1] + FFV1P0_3_replace + text_copy[linebreaks[-4]+1:]
    ...
    if (vertex == 'LLV1_2'):
        ...
        + '      COMPLEX*16 TMP2\n'
        LLV1_2_replace = '      TMP1 = F1(4)*V3(3) - F1(3)*V3(4)\n'\
            + '      TMP2 = F1(3)*V3(6) - F1(4)*V3(5)\n'\
            + '      DENOM = COUP/(P2(0)**2-P2(1)**2-P2(2)**2-P2(3)**2)\n'\
            + '      F2(3) = DENOM*CI*(TMP1*(P2(1) + CI*P2(2)) + TMP2*(P2(0) + P2(3)))\n'\
            + '      F2(4) = DENOM*CI*(TMP1*(P2(0) - P2(3)) + TMP2*(P2(1) - CI*P2(2)))\n'\
            + '      F2(5) = 0\n'\
            + '      F2(6) = 0\n'
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[14]+1] + TMP_replace + text_copy[linebreaks[14]+1:linebreaks[-19]+1] + LLV1_2_replace + text_copy[linebreaks[-4]+1:]
 """ 
    if (vertex == 'RRV1_1'):
    ...
    if (vertex == 'VVV1_0'):
        ...
        + '      COMPLEX*16 TMP8\n' \
        + '      COMPLEX*16 TMP9\n' \
        + '      REAL*8 P1P,P1M,P2P,P2M,P3P,P3M\n'

        VVV1_0_replace = '      P1P = DBLE(V1(1)) + DIMAG(V1(1))\n' \
        + '      P1M = DBLE(V1(1)) - DIMAG(V1(1))\n' \
        + '      P2P = DBLE(V2(1)) + DIMAG(V2(1))\n' \
        ...
        + '      TMP6 = {}\n'.format(vec_pv('V1','V3','P3')) \
        + '      TMP7 = {}\n'.format(vec_vec('V3','V1')) \
        + '      TMP8 = {}\n'.format(vec_pv('V2','V3','P3')) \
        + '      TMP9 = {}\n'.format(vec_pv('V2','V1','P1')) \
        + '      VERTEX = 0.25*COUP*CI*(TMP1*(TMP2 - TMP3) + TMP4*(TMP5 - TMP6) + TMP7*(TMP8 - TMP9))\n'
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[9]+1] + TMP_replace + text_copy[linebreaks[21]+1:linebreaks[25]+1] + VVV1_0_replace + text_copy[linebreaks[48]+1:]
    
    if (vertex == 'VLVLVL1_0' or vertex == 'VRVRVR1_0'):
        
        VVV1_0_replace = '      VERTEX = 0\n'
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[12]+1] + text_copy[linebreaks[21]+1:linebreaks[37]+1] + VVV1_0_replace + text_copy[linebreaks[48]+1:]
    ...
    if (vertex == 'VIVLVR1_0'):
        ...
        VVV1_0_replace = '      TMP1 = {}\n'.format(vec_vec('V2','V3')) \
        + '      TMP2 = {}\n'.format(vec_pvs('V1','V2')) \
        + '      TMP3 = {}\n'.format(vec_pvs('V1','V3')) \
        + '      VERTEX = 0.25*COUP*CI*(TMP1*(TMP2 - TMP3))\n'
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[9]+1] + TMP_replace + text_copy[linebreaks[21]+1:linebreaks[25]+1] + VVV1_0_replace + text_copy[linebreaks[48]+1:]
    ...
    if (vertex == 'VVRVR1_0'):
        ...
        + '      TMP6 = {}\n'.format(vec_pv('V2','V1','P1')) \
        + '      VERTEX = 0.25*COUP*CI*(TMP1*(TMP2 - TMP3) + TMP4*(TMP5 - TMP6))\n'
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[12]+1] + TMP_replace + text_copy[linebreaks[21]+1:linebreaks[25]+1] + VVRVR1_0_replace + text_copy[linebreaks[48]+1:]
    ...
    if (vertex == 'VVLVL1_0'):
        ...
        VVLVL1_0_replace = '      P1P = DBLE(V1(1)) + DIMAG(V1(1))\n' \
        + '      P1M = DBLE(V1(1)) - DIMAG(V1(1))\n' \
        + '      TMP1 = {}\n'.format(vec_vec('V1','V2')) \
        + '      TMP2 = {}\n'.format(vec_pv('V3','V1','P1')) \
        + '      TMP3 = {}\n'.format(vec_pvs('V3','V2')) \
        ...
        + '      VERTEX = 0.25*COUP*CI*(TMP1*(TMP2 - TMP3) + TMP4*(TMP5 - TMP6))\n'
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[9]+1] + TMP_replace + text_copy[linebreaks[21]+1:linebreaks[25]+1] + VVLVL1_0_replace + text_copy[linebreaks[48]+1:]
    ...
    if (vertex == 'VLVLVR1_0'):
        ...
        VVV1_0_replace = '      P3P = DBLE(V3(1)) + DIMAG(V3(1))\n' \
        + '      P3M = DBLE(V3(1)) - DIMAG(V3(1))\n' \
        + '      TMP1 = {}\n'.format(vec_vec('V2','V3')) \
        + '      TMP2 = {}\n'.format(vec_pvs('V1','V2')) \
        + '      TMP3 = {}\n'.format(vec_pv('V1','V3','P3')) \
    ...
    if (vertex == 'VLVRVR1_0'):
        ...
        VLVRVR1_0_replace = '      P1P = DBLE(V1(1)) + DIMAG(V1(1))\n' \
        + '      P1M = DBLE(V1(1)) - DIMAG(V1(1))\n' \
        + '      TMP1 = {}\n'.format(vec_vec('V1','V2')) \
        + '      TMP2 = {}\n'.format(vec_pv('V3','V1','P1')) \
        + '      TMP3 = {}\n'.format(vec_pvs('V3','V2')) \
    ...
    if (vertex == 'VVV1P0_1'):
        ...
        VVV1P0_1_replace = '      V1(1) = +V2(1)+V3(1)\n' \
        + '      V1(2) = +V2(2)+V3(2)\n' \
        + '      P1(0) = -DBLE(V1(1))\n' \
        + '      P1(1) = -DBLE(V1(2))\n' \
        + '      P1(2) = -DIMAG(V1(2))\n' \
    ...
    if (vertex == 'VLVLVL1P0_1'):
        ...
        + '      COMPLEX*16 TMP3\n' \
        + '      REAL*8 P1P,P1M\n'
        VLVLVL1P0_1_replace = '      V1(1) = +V2(1)+V3(1)\n' \
        + '      V1(2) = +V2(2)+V3(2)\n' \
        + '      P1(0) = -DBLE(V1(1))\n' \
        + '      P1(1) = -DBLE(V1(2))\n' \
        + '      P1(2) = -DIMAG(V1(2))\n' \
        ...
        + '      V1(6) = -DENOM*CI*((TMP0 - TMP1)*V2(6) + (TMP2 - TMP3)*V3(6))\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[13]+1] + TMP_replace + text_copy[linebreaks[18]+1:linebreaks[23]+1] + VLVLVL1P0_1_replace + text_copy[linebreaks[52]+1:]
    ...
    if (vertex == 'VLVLVL1P0_2') or (vertex == 'VRVRVR1P0_2'):
        ...
        VLVLVL1P0_1_replace = '      V2(1) = +V1(1)+V3(1)\n' \
        + '      V2(2) = +V1(2)+V3(2)\n' \
        + '      P2(0) = -DBLE(V2(1))\n' \
        + '      P2(1) = -DBLE(V2(2))\n' \
        + '      P2(2) = -DIMAG(V2(2))\n' \
        ...
        + '      V2(6) = DENOM*CI*((TMP0 - TMP1)*V1(6) + (TMP2 - TMP3)*V3(6))\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[13]+1] + TMP_replace + text_copy[linebreaks[18]+1:linebreaks[37]+1] + VLVLVL1P0_1_replace + text_copy[linebreaks[52]+1:]

    if (vertex == 'VRVRVR1P0_1'):
        # AW: we only divide by 2 here, could it be because we dont have the factor *2 from LRV_3 in g g to d d~ ?
        TMP_replace = '      COMPLEX*16 TMP0\n' \
        + '      COMPLEX*16 TMP1\n' \
        + '      COMPLEX*16 TMP2\n' \
        ...
        VRVRVR1P0_1_replace = '      V1(1) = +V2(1)+V3(1)\n' \
        + '      V1(2) = +V2(2)+V3(2)\n' \
        + '      P1(0) = -DBLE(V1(1))\n' \
        + '      P1(1) = -DBLE(V1(2))\n' \
        + '      P1(2) = -DIMAG(V1(2))\n' \
        ...
        + '      V1(6) = -DENOM*CI*((TMP0 - TMP1)*V2(6) + (TMP2 - TMP3)*V3(6))\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[13]+1] + TMP_replace + text_copy[linebreaks[18]+1:linebreaks[23]+1] + VRVRVR1P0_1_replace + text_copy[linebreaks[52]+1:]

    if (vertex == 'VVVV1_0' or vertex == 'VLVRVRVR1_0' or vertex == 'VLVLVLVR1_0'):
        # AW:
        TMP_replace = '      COMPLEX*16 TMP1\n' \
        + '      COMPLEX*16 TMP2\n' \
        + '      COMPLEX*16 TMP3\n' \
        ...
        VVVV1_0_replace = '      TMP1 = {}\n'.format(vec_vec('V1','V4')) \
        + '      TMP2 = {}\n'.format(vec_vec('V2','V3')) \
        + '      TMP3 = {}\n'.format(vec_vec('V1','V3')) \
        + '      TMP4 = {}\n'.format(vec_vec('V2','V4')) \
        + '      VERTEX = COUP*CI*(TMP1*TMP2 - TMP3*TMP4)/4\n'

        text_copy = text_copy[:linebreaks[8]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[17]+1] + VVVV1_0_replace + text_copy[linebreaks[22]+1:]
        
    if (vertex == 'VVVV3_0' or vertex == 'VLVRVRVR3_0' or vertex == 'VLVLVLVR3_0'):
        # AW:
        TMP_replace = '      COMPLEX*16 TMP1\n' \
        + '      COMPLEX*16 TMP2\n' \
        + '      COMPLEX*16 TMP3\n' \
        ...
        VVVV3_0_replace = '      TMP1 = {}\n'.format(vec_vec('V1','V4')) \
        + '      TMP2 = {}\n'.format(vec_vec('V2','V3')) \
        + '      TMP3 = {}\n'.format(vec_vec('V1','V2')) \
        + '      TMP4 = {}\n'.format(vec_vec('V3','V4')) \
        + '      VERTEX = COUP*CI*(TMP1*TMP2 - TMP3*TMP4)/4\n'

        text_copy = text_copy[:linebreaks[8]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[17]+1] + VVVV3_0_replace + text_copy[linebreaks[22]+1:]
        
    if (vertex == 'VVVV4_0' or vertex == 'VLVRVRVR4_0' or vertex == 'VLVLVLVR4_0'):
        # AW:
        TMP_replace = '      COMPLEX*16 TMP1\n' \
        + '      COMPLEX*16 TMP2\n' \
        + '      COMPLEX*16 TMP3\n' \
    ...
    if (vertex == 'VVVV1P0_1'):
        ...
        TMP_replace = '      COMPLEX*16 TMP1\n' \
        + '      COMPLEX*16 TMP2\n'
        misc.sprint(text_copy[linebreaks[26]+1:linebreaks[28]+1])
        VVVV1P0_1_replace = '      TMP1 = {}\n'.format(vec_vec('V2','V3')) \
        + '      TMP2 = {}\n'.format(vec_vec('V2','V4')) \
        + '      V1(3) = -DENOM*CI*(TMP1*V4(3) - TMP2*V3(3))/2\n' \
        + '      V1(4) = -DENOM*CI*(TMP1*V4(4) - TMP2*V3(4))/2\n' \
        + '      V1(5) = -DENOM*CI*(TMP1*V4(5) - TMP2*V3(5))/2\n' \
        + '      V1(6) = -DENOM*CI*(TMP1*V4(6) - TMP2*V3(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV1P0_1_replace + text_copy[linebreaks[32]+1:]
    ...
    if (vertex == 'VVVV3P0_1'):
        ...
        VVVV3P0_1_replace = '      TMP1 = {}\n'.format(vec_vec('V2','V3')) \
        + '      TMP2 = {}\n'.format(vec_vec('V3','V4')) \
        + '      V1(3) = -DENOM*CI*(TMP1*V4(3) - TMP2*V2(3))/2\n' \
        + '      V1(4) = -DENOM*CI*(TMP1*V4(4) - TMP2*V2(4))/2\n' \
        + '      V1(5) = -DENOM*CI*(TMP1*V4(5) - TMP2*V2(5))/2\n' \
        + '      V1(6) = -DENOM*CI*(TMP1*V4(6) - TMP2*V2(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV3P0_1_replace + text_copy[linebreaks[32]+1:]
    ...
    if (vertex == 'VVVV4P0_1'):
        ...
        VVVV4P0_1_replace = '      TMP1 = {}\n'.format(vec_vec('V2','V4')) \
        + '      TMP2 = {}\n'.format(vec_vec('V3','V4')) \
        + '      V1(3) = -DENOM*CI*(TMP1*V3(3) - TMP2*V2(3))/2\n' \
        + '      V1(4) = -DENOM*CI*(TMP1*V3(4) - TMP2*V2(4))/2\n' \
        + '      V1(5) = -DENOM*CI*(TMP1*V3(5) - TMP2*V2(5))/2\n' \
        + '      V1(6) = -DENOM*CI*(TMP1*V3(6) - TMP2*V2(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV4P0_1_replace + text_copy[linebreaks[32]+1:]

    if (vertex == 'VLVLVLVR1P0_1'):
        # AW:
        TMP_replace = '      COMPLEX*16 TMP1\n'

        VLVLVLVR1P0_1_replace = '      TMP1 = CI*DENOM*0.5*({})\n'.format(vec_vec('V2','V4')) \
        + '      V1(3) = TMP1*V3(3)\n' \
        + '      V1(4) = TMP1*V3(4)\n' \
        + '      V1(5) = TMP1*V3(5)\n' \
        + '      V1(6) = TMP1*V3(6)\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VLVLVLVR1P0_1_replace + text_copy[linebreaks[32]+1:]

    if (vertex == 'VLVLVLVR3P0_1'):
        # AW:
        TMP_replace = '      COMPLEX*16 TMP1\n'

        VLVLVLVR3P0_1_replace = '      TMP1 = CI*DENOM*0.5*({})\n'.format(vec_vec('V3','V4')) \
        + '      V1(3) = TMP1*V2(3)\n' \
        + '      V1(4) = TMP1*V2(4)\n' \
        + '      V1(5) = TMP1*V2(5)\n' \
        + '      V1(6) = TMP1*V2(6)\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VLVLVLVR3P0_1_replace + text_copy[linebreaks[32]+1:]

    if (vertex == 'VLVLVLVR4P0_1'):
        # AW:
        TMP_replace = '      COMPLEX*16 TMP1\n' \
        + '      COMPLEX*16 TMP2\n'

        VVVV4P0_1_replace = '      DENOM = 0.5*COUP/(P1(0)**2-P1(1)**2-P1(2)**2-P1(3)**2 - M1 * (M1 -CI * W1))\n'\
        + '      TMP1 = {}\n'.format(vec_vec('V2','V4')) \
        + '      TMP2 = {}\n'.format(vec_vec('V3','V4')) \
        + '      V1(3) = -DENOM*CI*(TMP1*V3(3) - TMP2*V2(3))\n' \
        + '      V1(4) = -DENOM*CI*(TMP1*V3(4) - TMP2*V2(4))\n' \
        + '      V1(5) = -DENOM*CI*(TMP1*V3(5) - TMP2*V2(5))\n' \
        + '      V1(6) = -DENOM*CI*(TMP1*V3(6) - TMP2*V2(6))\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + VVVV4P0_1_replace + text_copy[linebreaks[32]+1:]
    ...
    if (vertex == 'VVVV1P0_2'):
        ...
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV1P0_2_replace + text_copy[linebreaks[32]+1:]
    ...
    if (vertex == 'VVVV3P0_2'):
        ...
        VVVV3P0_2_replace = '      TMP1 = {}\n'.format(vec_vec('V1','V4')) \
        + '      TMP2 = {}\n'.format(vec_vec('V3','V4')) \
        + '      V2(3) = -DENOM*CI*(TMP1*V3(3) - TMP2*V1(3))/2\n' \
        + '      V2(4) = -DENOM*CI*(TMP1*V3(4) - TMP2*V1(4))/2\n' \
        + '      V2(5) = -DENOM*CI*(TMP1*V3(5) - TMP2*V1(5))/2\n' \
        + '      V2(6) = -DENOM*CI*(TMP1*V3(6) - TMP2*V1(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV3P0_2_replace + text_copy[linebreaks[32]+1:]
    ...
    if (vertex == 'VIVLVLVR3P0_2'):
        # AW:
        TMP_replace = '      COMPLEX*16 TMP1\n'

        VVVV3P0_2_replace = '      TMP1 = {}\n'.format(vec_vec('V3','V4')) \
        + '      V2(3) = DENOM*CI*(TMP1*V1(3))/2\n' \
        + '      V2(4) = DENOM*CI*(TMP1*V1(4))/2\n' \
        + '      V2(5) = DENOM*CI*(TMP1*V1(5))/2\n' \
        + '      V2(6) = DENOM*CI*(TMP1*V1(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV3P0_2_replace + text_copy[linebreaks[32]+1:]

    if (vertex == 'VIVLVLVR4P0_2'):
        # AW:
        TMP_replace = '      COMPLEX*16 TMP1\n'
    ...
    if (vertex == 'VVVV1P0_3'):
        # AW: Hacking the VVVV_3 files for now
        TMP_replace = '      COMPLEX*16 TMP1\n' \
        + '      COMPLEX*16 TMP2\n'

        VVVV1P0_2_replace = '      TMP1 = {}\n'.format(vec_vec('V1','V4')) \
        + '      TMP2 = {}\n'.format(vec_vec('V2','V4')) \
        + '      V3(3) = -DENOM*CI*(TMP1*V2(3) - TMP2*V1(3))/2\n' \
        + '      V3(4) = -DENOM*CI*(TMP1*V2(4) - TMP2*V1(4))/2\n' \
        + '      V3(5) = -DENOM*CI*(TMP1*V2(5) - TMP2*V1(5))/2\n' \
        + '      V3(6) = -DENOM*CI*(TMP1*V2(6) - TMP2*V1(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV1P0_2_replace + text_copy[linebreaks[32]+1:]
    ...
    if (vertex == 'VVVV3P0_3'):
        ...
        VVVV3P0_2_replace = '      TMP1 = {}\n'.format(vec_vec('V1','V4')) \
        + '      TMP2 = {}\n'.format(vec_vec('V1','V2')) \
        + '      V3(3) = -DENOM*CI*(TMP1*V2(3) - TMP2*V4(3))/2\n' \
        + '      V3(4) = -DENOM*CI*(TMP1*V2(4) - TMP2*V4(4))/2\n' \
        + '      V3(5) = -DENOM*CI*(TMP1*V2(5) - TMP2*V4(5))/2\n' \
        + '      V3(6) = -DENOM*CI*(TMP1*V2(6) - TMP2*V4(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV3P0_2_replace + text_copy[linebreaks[32]+1:]
    ...
    if (vertex == 'VVVV4P0_3'):
        ...
        VVVV4P0_2_replace = '      TMP1 = {}\n'.format(vec_vec('V1','V2')) \
        + '      TMP2 = {}\n'.format(vec_vec('V2','V4')) \
        + '      V3(3) = DENOM*CI*(TMP1*V4(3) - TMP2*V1(3))/2\n' \
        + '      V3(4) = DENOM*CI*(TMP1*V4(4) - TMP2*V1(4))/2\n' \
        + '      V3(5) = DENOM*CI*(TMP1*V4(5) - TMP2*V1(5))/2\n' \
        + '      V3(6) = DENOM*CI*(TMP1*V4(6) - TMP2*V1(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV4P0_2_replace + text_copy[linebreaks[32]+1:]

    if (vertex == 'VIVLVRVR1P0_3'):
        # AW: Hacking the VVVV_3 files for now
        TMP_replace = '      COMPLEX*16 TMP2\n'

        VVVV1P0_2_replace = '      TMP1 = {}\n'.format(vec_vec('V2','V4')) \
        + '      V3(3) = DENOM*CI*(TMP2*V1(3))/2\n' \
        + '      V3(4) = DENOM*CI*(TMP2*V1(4))/2\n' \
        + '      V3(5) = DENOM*CI*(TMP2*V1(5))/2\n' \
        + '      V3(6) = DENOM*CI*(TMP2*V1(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV1P0_2_replace + text_copy[linebreaks[32]+1:]

    if (vertex == 'VIVLVRVR3P0_3'):
        # AW:
        TMP_replace = '      COMPLEX*16 TMP1\n' \
        + '      COMPLEX*16 TMP2\n'
    ...
    if (vertex == 'VVIVLVL4P0_3'):
        # AW:
        TMP_replace = '      COMPLEX*16 TMP1\n'

        VVVV4P0_2_replace = '      TMP1 = {}\n'.format(vec_vec('V1','V2')) \
        + '      V3(3) = DENOM*CI*(TMP1*V4(3))/2\n' \
        + '      V3(4) = DENOM*CI*(TMP1*V4(4))/2\n' \
        + '      V3(5) = DENOM*CI*(TMP1*V4(5))/2\n' \
        + '      V3(6) = DENOM*CI*(TMP1*V4(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV4P0_2_replace + text_copy[linebreaks[32]+1:]
    ...
    if (vertex == 'VLVRVRVR3P0_2' or vertex == 'VVLVLVL3P0_2' or vertex == 'VVRVRVR3P0_2'):
        ...
        VLVRVRVR3P0_2_replace = '      TMP1 = {}\n'.format(vec_vec('V1','V4')) \
        + '      V2(3) = -DENOM*CI*TMP1*V3(3)/2\n' \
        + '      V2(4) = -DENOM*CI*TMP1*V3(4)/2\n' \
        + '      V2(5) = -DENOM*CI*TMP1*V3(5)/2\n' \
        + '      V2(6) = -DENOM*CI*TMP1*V3(6)/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
    ...
    if (vertex == 'VLVRVRVR4P0_2' or vertex == 'VVLVLVL4P0_2' or vertex == 'VVRVRVR4P0_2'):
        ...
        VLVRVRVR4P0_2_replace = '      TMP1 = {}\n'.format(vec_vec('V1','V3')) \
        + '      V2(3) = -DENOM*CI*TMP1*V4(3)/2\n' \
        + '      V2(4) = -DENOM*CI*TMP1*V4(4)/2\n' \
        + '      V2(5) = -DENOM*CI*TMP1*V4(5)/2\n' \
        + '      V2(6) = -DENOM*CI*TMP1*V4(6)/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VLVRVRVR4P0_2_replace + text_copy[linebreaks[32]+1:]
    ...
    if (vertex == 'VVVV1P0_4'):
        ...
        VVVV1P0_1_replace = '      TMP1 = {}\n'.format(vec_vec('V2','V3')) \
        + '      TMP2 = {}\n'.format(vec_vec('V1','V3')) \
        + '      V1(3) = -DENOM*CI*(TMP1*V1(3) - TMP2*V2(3))/2\n' \
        + '      V1(4) = -DENOM*CI*(TMP1*V1(4) - TMP2*V2(4))/2\n' \
        + '      V1(5) = -DENOM*CI*(TMP1*V1(5) - TMP2*V2(5))/2\n' \
        + '      V1(6) = -DENOM*CI*(TMP1*V1(6) - TMP2*V2(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV1P0_1_replace + text_copy[linebreaks[32]+1:]
    ...
    if (vertex == 'VVVV3P0_4'):
        ...
        VVVV3P0_1_replace = '      TMP1 = {}\n'.format(vec_vec('V2','V3')) \
        + '      TMP2 = {}\n'.format(vec_vec('V1','V2')) \
        + '      V1(3) = -DENOM*CI*(TMP1*V1(3) - TMP2*V3(3))/2\n' \
        + '      V1(4) = -DENOM*CI*(TMP1*V1(4) - TMP2*V3(4))/2\n' \
        + '      V1(5) = -DENOM*CI*(TMP1*V1(5) - TMP2*V3(5))/2\n' \
        + '      V1(6) = -DENOM*CI*(TMP1*V1(6) - TMP2*V3(6))/2\n'   
        linebreaks = get_symbols(text_copy, '\n')
        text_copy = text_copy[:linebreaks[10]+1] + TMP_replace + text_copy[linebreaks[12]+1:linebreaks[24]+1] + text_copy[linebreaks[26]+1:linebreaks[28]+1] + VVVV3P0_1_replace + text_copy[linebreaks[32]+1:]
...
def postex_vertex_replacer(working_dir):
    ...
    # AW: added VVV1_0.f, 'VVV1P0_1.f', 'VVVV1_0.f', 'VVVV3_0.f', 'VVVV4_0.f', 'VVVV1P0_1.f', 'VVVV3P0_1.f' and 'VVVV4P0_1.f' etc.
    vertex_list = [ 'LRV1_0.f', 'RLV1_0.f', 'LRV1_3.f', 'RLV1_3.f',\
        ...
        'VIVLVR1_0.f','VLVLVL1P0_2.f','VRVRVR1P0_2.f', 'VLVLVL1_0.f', 'VVIVLVR1_0.f', 'VVIVLVR3_0.f', 'VVIVLVR4_0.f', \
        'VLVRVRVR1_0.f', 'VLVRVRVR3_0.f', 'VLVRVRVR4_0.f', 'VRVRVR1_0.f', 'VLVLVLVR1_0.f', 'VLVLVLVR3_0.f', 'VLVLVLVR4_0.f', \
        'VVVIVL1_0.f', 'VVVIVL3_0.f', 'VVVIVL4_0.f', 'VVVLVL1_0.f', 'VVVLVL3_0.f', 'VVVLVL4_0.f', \
